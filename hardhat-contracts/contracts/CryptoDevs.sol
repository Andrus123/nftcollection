...
contract CryptoDevs is ERC721Enumerable, Ownable {
    ...
    // _price is the price of one Crytpo Dev NFT
    uint256 public _price = 0.01 ether;

    // _paused is used to pause the contract in case of an empergency
    bool public _paused;
    ...
    */
    ...
    // Function to receive Ether.mgs.data must be empty
